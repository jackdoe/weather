...
const url = "https://www.latlong.net/category/cities-32-15.html";
...
//requesting cities of Brazil included longitude and latitude
curl.get(url, null, (err, resp, body) => {
  console.log(`Requesting cities of Brazil.StatusCode-> ${resp.statusCode}.`);
    ...
    curl.get(
      ...
      (err, resp, body) => {
        ...
        if (resp.statusCode === 200 && resp.statusCode !== 404) {
          ...
          writeFile("This-Cities-Have-Weather-data.json", BrazilianCities);
        } else if (err) {
          console.log("Error while fetching");
        }
      }
