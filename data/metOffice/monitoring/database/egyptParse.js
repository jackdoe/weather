...
weatherElems = [
  ...
  { name: "temperatureMax", filename: "forecast_maximumtemperature.txt" },
  { name: "temperatureC", filename: "forecast_meantemperature.txt" },
  { name: "temperatureMin", filename: "forecast_minimumtemperature.txt" },
  { name: "precipitation", filename: "forecast_precipitation.txt" },
  { name: "humidityPercent", filename: "forecast_relativehumidity.txt" },
  { name: "windDirectionDeg", filename: "forecast_wind_direction.txt" },
  { name: "windSpeedMps", filename: "forecast_wind_speed.txt" }
];
