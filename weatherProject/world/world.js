...
async function main() {
    try {
        ...
        const addData = await readJSONFile("./world-app/src/stats/stats.json");
        addData.push(obj);
        await writeJSONFile("./world-app/src/stats/stats.json", addData);
    } catch (error) {
        console.log(error);
    }
}
